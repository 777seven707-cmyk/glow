...
Сетка в перспективе на обычном canvas 2D (`assets/js/wave.js`). Узлы считаются
...
| Приём | Значение |
|-------|----------|
| Частота кадров | ~38 в секунду, во время перетаскивания 60 |
| Сетка | 26 рядов × 34 столбца, продольные через один |
