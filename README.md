...
Своей анимации у линий нет: смещение задаёт прокрутка. Скрипт пишет в `--flow`
величину `pageYOffset / 900` (900 пикселей прокрутки = один полный проход), а
каждая кривая умножает её на свой `--k`, чтобы пучок не шёл монолитом. Стоишь
на месте — линии стоят, крутишь вверх — идут назад. Заодно весь пучок
