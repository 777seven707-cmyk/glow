...
italy/                     отдельный сайт про Италию (см. italy/README.md)
.nojekyll                  чтобы GitHub Pages отдавал файлы как есть
```

## Сайт про Италию

В папке `italy/` лежит второй независимый одностраничник — интерактивный
путеводитель по Италии: карта 20 регионов, лента истории, Колизей в разрезе и
в течение суток, кухня, разговорник с озвучкой и викторина. Светлая тема,
Plus Jakarta Sans, фотографии подтягиваются из Wikimedia Commons.
Открывается по адресу `/italy/`, ничего не требует от корневого сайта.
Подробности — в `italy/README.md`.
