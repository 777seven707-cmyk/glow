...
(function () {
  ...
  function bundle(position) {
    ...
    for (var i = 0; i < COUNT; i++) {
      ...
      var width = (0.5 + j * 0.026).toFixed(2);
      var op = (0.022 + j * 0.0045).toFixed(4);    // фон заметнее, но всё ещё не спорит с текстом
      var dur = (13 + (i % 7) * 1.8).toFixed(1);   // разброс задан один раз, не случайно каждый кадр
